...
LOADNAMETABLE1:
    ...
    LDX #$00
LOADBACKGROUND11:
    LDA BACKGROUNDDATA1, X
    STA PPUDATA
    INX
    CPX #$00
    BNE LOADBACKGROUND11
LOADBACKGROUND12:
    LDA BACKGROUNDDATA1+256, X
    STA PPUDATA
    INX
    CPX #$00
    BNE LOADBACKGROUND12
LOADBACKGROUND13:
    LDA BACKGROUNDDATA1+512, X
    STA PPUDATA
    INX
    CPX #$00
    BNE LOADBACKGROUND13
LOADBACKGROUND14:
    LDA BACKGROUNDDATA1+768, X
    STA PPUDATA
    INX
    CPX #$F0
    BNE LOADBACKGROUND14
...
LOADBACKGROUND21:
    ...
    INX
    CPX #$00
    BNE LOADBACKGROUND21
LOADBACKGROUND22:
    LDA BACKGROUNDDATA2+256, X
    STA PPUDATA
    INX
    CPX #$00
    BNE LOADBACKGROUND22
LOADBACKGROUND23:
    LDA BACKGROUNDDATA2+512, X
    STA PPUDATA
    INX
    CPX #$00
    BNE LOADBACKGROUND23
LOADBACKGROUND24:
    LDA BACKGROUNDDATA2+768, X
    STA PPUDATA
    INX
    CPX #$F0
    BNE LOADBACKGROUND24  
    ...
    STA PPUADDR
    LDX #$00
LOADBACKGROUNDPALETTEDATA1:
    LDA BACKGROUNDPALETTEDATA1, X
    STA PPUDATA
    INX
    CPX #$80
    BNE LOADBACKGROUNDPALETTEDATA1
    ...
    STA PPUADDR
    LDX #$00
LOADBACKGROUNDPALETTEDATA2:
    LDA BACKGROUNDPALETTEDATA2, X
    STA PPUDATA
    INX
    CPX #$80
    BNE LOADBACKGROUNDPALETTEDATA2
...
BACKGROUNDDATA1:
    .byte $00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01
    .byte $00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01
    .byte $00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01
    .byte $00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01
    .byte $00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01,$00,$01
